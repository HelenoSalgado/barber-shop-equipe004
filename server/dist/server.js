...
var require_prisma = __commonJS({
  "src/database/prisma.ts"(exports, module2) {
    "use strict";
...
var require_BarberShop = __commonJS({
  "src/controllers/BarberShop.ts"(exports, module2) {
    "use strict";
...
var require_verifyIdService = __commonJS({
  "src/helpers/service/verifyIdService.ts"(exports, module2) {
    "use strict";
...
var require_SchedulingController = __commonJS({
  "src/controllers/SchedulingController.ts"(exports, module2) {
    "use strict";
    var import_prisma = __toESM(require_prisma());
    ...
    module2.exports = SchedulingController;
  }
});
...
var require_UserController = __commonJS({
  "src/controllers/UserController.ts"(exports, module2) {
    "use strict";
    var import_prisma = __toESM(require_prisma());
    var import_zod7 = require("zod");
    ...
    module2.exports = UserController;
  }
});
...
var require_SessionController = __commonJS({
  "src/controllers/SessionController.ts"(exports, module2) {
    "use strict";
    var import_prisma = __toESM(require_prisma());
    init_valideSession();
...
var require_barberPublicRoutes = __commonJS({
  "src/routes/barberPublicRoutes.ts"(exports, module2) {
    "use strict";
    ...
    var publicRoutes = import_express2.default.Router();
    ...
    module2.exports = publicRoutes;
  }
});

// src/middlewares/authAdmin.ts
var require_authAdmin = __commonJS({
  "src/middlewares/authAdmin.ts"(exports, module2) {
    "use strict";
    var import_jsonwebtoken = __toESM(require("jsonwebtoken"));
    var import_dotenv2 = __toESM(require("dotenv"));
    import_dotenv2.default.config();
...
var require_barberAdminRoutes = __commonJS({
  "src/routes/barberAdminRoutes.ts"(exports, module2) {
    "use strict";
    var import_BarberShop = __toESM(require_BarberShop());
    var import_express2 = __toESM(require("express"));
    var import_authAdmin = __toESM(require_authAdmin());
    var barberRoutes = import_express2.default.Router();
    ...
    module2.exports = barberRoutes;
  }
});

// src/middlewares/tokenUser.ts
var require_tokenUser = __commonJS({
  "src/middlewares/tokenUser.ts"(exports, module2) {
    "use strict";
    var import_jsonwebtoken = __toESM(require("jsonwebtoken"));
    var import_dotenv2 = __toESM(require("dotenv"));
    import_dotenv2.default.config();
    ...
    module2.exports = tokenUser;
  }
});

// src/routes/userRoutes.ts
var require_userRoutes = __commonJS({
  "src/routes/userRoutes.ts"(exports, module2) {
    "use strict";
    var import_express2 = __toESM(require("express"));
    var import_SchedulingController = __toESM(require_SchedulingController());
    var import_UserController = __toESM(require_UserController());
    var import_tokenUser = __toESM(require_tokenUser());
    var userRoutes = import_express2.default.Router();
...
server.use("/api/v1/", require_barberPublicRoutes());
server.use("/api/v1/dashboard", require_barberAdminRoutes());
server.use("/api/v1/usuario", require_userRoutes());
server.listen(PORT, () => {
